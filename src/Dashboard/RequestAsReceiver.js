    ...
    <TopIconWrap>
        ...
        <Container>
           ...
           <MasterBox>
            ...
            <Box1><span><img src="icon (5) unside.png" />Adam Rewana Ikoyin Estate, Ikoyi</span><CloseIcon/></Box1>

            <Box2>
            <span><H7><img src="yellow icon (1).png" /><a>3, Idumota Lane, Lagos Island</a></H7><CloseIcon/></span>
            <span><H8><img src="yellow icon (2).png" /><a>Rasheed Aderanmisie</a></H8><CloseIcon/> </span>
            <span><H9><img src="yellow icon (3).png" /><a><input type="number" id="number" placeholder="+234 | 809 000 4030"/></a></H9><CloseIcon/></span>
            <span><H10><img src="icon (8).png" /><a>A new pair of adidas shoes</a></H10><CloseIcon/></span>
            </Box2>
            <Box3>
