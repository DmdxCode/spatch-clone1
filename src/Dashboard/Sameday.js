    ...
    <TopIconWrap>
        ...
        <Container>
           ...
           <MasterBox>
            ...
            <Box1><span><img src="icon (4).png" />Adam Rewana Ikoyin Estate, Ikoyi</span><CloseIcon/></Box1>

            <Box2>
            <span><H7><img src="icon (5).png" /><a>Where are we delivering to?</a></H7><GpsNotFixedOutlinedIcon/></span>
            <span><H8><img src="icon (6).png" /><a>Rasheed Aderanmisie</a></H8><CloseIcon/> </span>
            <span><H9><img src="icon (7).png" /><a><input type="number" id="number" placeholder="+234 | 809 000 4030"/></a></H9><CloseIcon/></span>
