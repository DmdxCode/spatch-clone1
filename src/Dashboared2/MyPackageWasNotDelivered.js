...
function MyPackageWasNotDelivered() {
  ...
  return (
    <>
        ...
        <Container>
            ...
            <MasterBox>
                <span><KeyboardBackspaceIcon fontSize="small" style={{paddingTop: "23px", color: "#7000f6"}}  /><h3>My package was not delivered</h3><img src="cancle icon.png"/></span>
                <h6>If you can figure it out, you can contact support team.</h6>
                
            <Input1>
                <input placeholder='Order ID' name="Order ID" type="text"/>
            </Input1>
            <Input2>
                <input placeholder='Give us more detail to work with' name="Details" type="text"/>
            </Input2>

            <AddBtn>Add attachment</AddBtn>
            <MiniBox>
                <CancelIcon style={{marginBottom: "50px", paddingLeft: "50px", color: "red", display: "flex"}}/>

            </MiniBox>
            <h7>Please add any picture or screenshots of the item</h7>
...
export default MyPackageWasNotDelivered
